 ...
 * @date 26/11/2014
 */
public class APVillotaConfig extends MetricConfig {
...
//		MeasurementPhase communicationSort = new MeasurementPhase("COMMUNICATION-SORT", stages){
//			
//			private static final long serialVersionUID = 1L;
//			
//			@Override
...
//		};
//		
//		MeasurementPhase communicationMerge = new MeasurementPhase("COMMUNICATION-MERGE", levels){
//			
//			private static final long serialVersionUID = 1L;
//			
//			@Override
...
//	
		phases.add(sorting);
		phases.add(merge);
		//phases.add(communicationSort);
		//phases.add(communicationMerge);
